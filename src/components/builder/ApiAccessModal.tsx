      ...
      <div className="w-full max-w-2xl bg-zinc-900 border border-zinc-800 rounded-2xl shadow-2xl overflow-hidden shadow-emerald-900/10">
        <div className="p-4 border-b border-zinc-800 flex items-center justify-between bg-zinc-900/50">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-xs font-bold uppercase tracking-widest text-zinc-300">API Access</h3>
          </div>
        ...
        <div className="p-6 space-y-6">
          <div className="space-y-1">
            ...
            <p className="text-sm text-zinc-400">Unlock programmatic access to the Trend-Equity AI Engine to power your own workflows.</p>
          </div>

          <div className="space-y-2">
            <label className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest ml-1">Your API Secret Key</label>
            <div className="flex items-center gap-2">
            ...
            <p className="text-[10px] text-zinc-500 italic mt-1">Do not expose this key in client-side code.</p>
          </div>
  ...
  -d '{
    ...
    "date": "2026-03-23"
          ...
          <div className="grid grid-cols-3 gap-4 border-t border-zinc-800 pt-6">
            <div className="space-y-1">
              <p className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">Rate Limit</p>
              <p className="text-lg font-black text-white">100<span className="text-xs text-zinc-500 font-normal">/min</span></p>
            </div>
            <div className="space-y-1">
            ...
            <div className="space-y-1">
              ...
              <p className="text-lg font-black text-emerald-500 flex items-center gap-1.5"><span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>Active</p>
            </div>
          </div>
        </div>
      </div>

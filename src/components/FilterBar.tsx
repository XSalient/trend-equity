...
export function FilterBar({ filters, setFilters, tier }: FilterBarProps) {
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <select 
              ...
              className="bg-transparent text-sm text-zinc-400 border-none focus:ring-0 cursor-pointer hover:text-white"
            >
              <option value="revenue">Sort by Potential</option>

        ...
        <div className="flex items-center justify-between relative z-10">
          <div className="space-y-1">
            ...
            <p className="text-zinc-500 text-xs uppercase font-bold tracking-widest">
              Horizon: {futurecasting?.horizon || '2030'}
            </p>
          </div>
          <div className="flex items-center gap-2">
            ...
            >
              <RefreshCw
                className={`w-5 h-5 text-amber-500 ${loadingFuture ? 'animate-spin' : ''}`}
              />
            </button>
          </div>
        </div>
        ...
        {loadingFuture ? (
          ...
          <div className="py-12 text-center space-y-4">
            ...
            <p className="text-xs text-zinc-500">
              Select a horizon and click refresh to generate predictions.
            </p>
          </div>
        )}
      </div>
